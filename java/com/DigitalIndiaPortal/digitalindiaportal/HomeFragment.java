...
Button govtLogin,pvtlogin,userLogin,adminLogin;
...
ProgressBar sldierProgress;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adminLogin=view.findViewById(R.id.admin);
        ...
        adminLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent jumpAdmin = new Intent(getActivity().getApplication(),AdminLogin.class);
      ...
      userLogin.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent jumpLogin = new Intent(getActivity().getApplication(),UserLogin.class);
